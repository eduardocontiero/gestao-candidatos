...
export default {
    components: { Loading },
    props: ["userData", "professionalData", "academicData"],
    data: function () {
        return {
            user: {},
            errors: [],
    ...
    mounted() {
        ...
        this.professionalData.forEach((value) => {
            this.professional_qualifications.push(value);
        });

        this.academicData.forEach((value) => {
            this.academic_qualifications.push(value);
        });
    },
    methods: {
        _saveUser() {
